use crate::apis::call_request::call_llm_api;
...
const CODE_TEMPLATE_PATH: &str =
    r#"C:\Users\shive\Desktop\RustProj\auto_gpt\web_template\src\code_template.rs"#;

pub const WEB_SERVER_PROJECT_PATH: &str =
    r#"C:\Users\shive\Desktop\RustProj\auto_gpt\web_template\"#;

pub const EXEC_MAIN_PATH: &str =
    r#"C:\Users\shive\Desktop\RustProj\auto_gpt\web_template\src\main.rs"#;

const API_SCHEMA_PATH: &str = r#"C:\Users\shive\Desktop\RustProj\auto_gpt\schemas\api_schema.json"#;
...
pub async fn ai_task_request(
    ...
    let llm_response_res: Result<String, Box<dyn std::error::Error + Send>> =
        call_llm_api(vec![extended_msg.clone()]).await;

    // Return Success or try again
    match llm_response_res {
        Ok(llm_resp) => llm_resp,
        Err(_) => call_llm_api(vec![extended_msg.clone()])
            .await
