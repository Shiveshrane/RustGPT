...
mod tests {
    ...
    async fn tests_solution_architect() {
      ...
      project_description: "Build a full stack website with user login and logout that shows latest Forex prices and returns latest price of Bitcoin.".to_string(),
      project_scope: None,
      external_urls: None,
      backend_code: None,
